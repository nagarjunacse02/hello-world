def call(String jfrogArtifactory, String imageName) {
  ...
  sh "docker tag youtube-1.1 fisdemo1.jfrog.io/demo-fis-docker-docker-local/youtube-1.1:latest"
  sh "docker push fisdemo1.jfrog.io/demo-fis-docker-docker-local/youtube-1.1:latest"
}
